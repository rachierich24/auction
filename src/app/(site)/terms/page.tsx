...
export const metadata: Metadata = {
  ...
  description:
    "The terms on which Maison Auctions accepts bids, closes lots, applies reserves and buyer's premium, and settles sales.",
...
export default async function TermsPage() {
  ...
  return (
    <LegalPage
      eyebrow="Legal"
      title="Conditions of sale"
      intro="These conditions govern bidding and buying at Maison Auctions. By registering and placing a bid you agree to them."
      clauses={clauses}
    />
  );
}
